...
export default function DeleteManyIcon(props: { selectionModel: GridSelectionModel, markForDelete: () => any, singular: string, plural?: string }) {

    const notification = useSnackbarNotification();

    return (
        <IconButton disabled={props.selectionModel.length === 0}
                    onClick={() => {
